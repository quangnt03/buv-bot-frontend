...
export const ItemIcon = ({ size = 16 }: { size?: number }) => (
  <svg viewBox="0 0 24 24" className="h-6 w-6">
    <path fill="#5E72E4" d="M19,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.1,3,19,3z M9.5,15H8V8h1.5V15z M12.75,15h-1.5V8h1.5V15z M16,15h-1.5V8H16V15z"/>
  </svg>
)
